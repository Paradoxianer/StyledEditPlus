...
const t_rgbColor rgbColors[] = { 
							   { "BeFocusBlue", BeFocusBlue },
							   { "BeHighlight", BeHighlight },
							   { "BeShadow", BeShadow },
							   { "BeDarkShadow", BeDarkShadow },
							   { "BeLightShadow", BeLightShadow },
							   { "BeButtonGrey", BeButtonGrey },
							   { "BeInactiveGrey", BeInactiveGrey },
							   { "BeListSelectGrey", BeListSelectGrey },
							   { "BeTitleBarYellow", BeTitleBarYellow },
							   { "Black", Black },
							   { "White", White },
							   { "Red", Red },
							   { "Green", Green },
							   ...
							   { "Brown", Brown },
							   { "Grey", Grey },
							   { "LightMetallicBlue", LightMetallicBlue },
							   { "MedMetallicBlue", MedMetallicBlue  },
							   { "DarkMetallicBlue", DarkMetallicBlue  }
                               };
